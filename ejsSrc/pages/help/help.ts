...
export interface THelpEcmpt extends Ecmpt {

}

export const createHelpPage =async (ecmpt: THelpEcmpt): Promise<THelpEcmpt> => {
    ...
    const page = {
        ...
        slots: {
            topBar: await eRender(createTopBar({props: {title: '同步书籍教程'}})),
            version: versionName,
        },
    }
